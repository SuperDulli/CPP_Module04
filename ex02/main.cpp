...
int	main(void) {
	// AAnimal abstractAnimal = new AAnimal(); // can't instanciate object of an abstract class
	...
	std::cout << std::string(80, '-') << std::endl;
	{
		std::cout << "Testing AAnimals with brains" << std::endl;
	...
	}
	{
		...
		int const	zooSize = 6;
		// AAnimal*	zoo = new AAnimal[zooSize];
		AAnimal*		zoo[zooSize];
